...
#ifndef dz_13_Obj_Skut_Thread_h
#define dz_13_Obj_Skut_Thread_h

#include <stdio.h>

#endif /* dz_13_Obj_Skut_Thread_h */
...
Нравится11Показать список оценившихОтветить
